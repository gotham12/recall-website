...
export function ResearchProblemSection() {
  const [intro, stats, gapsBg, crisis] = PROBLEM_SECTION_BACKGROUNDS;
  ...
  return (
    <>
      <ScrollVelocity
        ...
        velocity={80}
        className="relative z-20 text-base font-medium uppercase tracking-[0.2em] text-zinc-500 md:text-lg"
        parallaxClassName="border-y border-zinc-800/50 bg-black/35 py-5 backdrop-blur-md"
      />

      <SectionPanel background={intro.src} tone={intro.tone}>
        <section id="problem" aria-labelledby="problem-heading" className="relative w-full py-12 md:py-16">
          <div className="mx-auto max-w-6xl px-6">
            <FadeContent blur className="max-w-4xl">
              ...
              <p id="problem-heading" className="mt-6 text-xl leading-relaxed text-zinc-300 md:text-2xl">
      ...
      <SectionPanel background={stats.src} tone={stats.tone}>
        <section aria-labelledby="problem-stats" className="relative w-full py-12 md:py-16">
          <div className="mx-auto max-w-6xl px-6">
      ...
      <SectionPanel background={gapsBg.src} tone={gapsBg.tone}>
        <section aria-labelledby="problem-gaps" className="relative w-full py-12 md:py-16">
          <div className="mx-auto max-w-6xl px-6">
            <FadeContent blur className="mb-12">
              <h3 id="problem-gaps" className="font-display text-3xl text-zinc-100 md:text-4xl lg:text-5xl">
                Six structural gaps families face every day
              </h3>
              <p className="mt-4 max-w-3xl text-lg text-zinc-400 md:text-xl">
                Sources:{' '}
                <a
      ...
      <SectionPanel background={crisis.src} tone={crisis.tone}>
        <section aria-labelledby="problem-crisis" className="relative w-full py-12 md:py-16">
          <div className="mx-auto max-w-6xl px-6">
            <FadeContent blur>
              <SpotlightCard
              ...
              >
                <div className="relative border-b border-zinc-800">
                  ...
                  <div className="absolute inset-0 flex items-end p-6 md:p-10">
                    <div>
                      <h3 id="problem-crisis" className="font-display text-3xl text-zinc-100 md:text-4xl lg:text-5xl">
